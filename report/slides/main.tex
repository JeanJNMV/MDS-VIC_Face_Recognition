...
\medskip
\centering
\includegraphics[width=0.75\linewidth]{../../figures/eigenfaces_hyper.png}
\end{frame}

% ------------------ Eigenfaces Robustness Figures ------------------
\begin{frame}{Eigenfaces: Robustness Curves}
\centering
\includegraphics[width=0.95\linewidth]{../../figures/eigenfaces_noise.png}

\medskip
\scriptsize (Optional detailed breakdown slide below.)
\end{frame}

\begin{frame}{Eigenfaces: Breakdown by Transformation}
\centering
\includegraphics[width=0.95\linewidth]{../../figures/eigenfaces_gb.png}\\[1mm]
\includegraphics[width=0.95\linewidth]{../../figures/eigenfaces_sp_noise.png}\\[1mm]
\includegraphics[width=0.95\linewidth]{../../figures/eigenfaces_rotations.png}\\[1mm]
\includegraphics[width=0.95\linewidth]{../../figures/eigenfaces_crops.png}
\end{frame}
...
\medskip
\centering
\includegraphics[width=0.95\linewidth]{../../figures/LBPH_robustness.png}
\end{frame}
