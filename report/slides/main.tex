...
\quad
X = [\mathbf{x}_1-\boldsymbol{\mu}, \dots, \mathbf{x}_N-\boldsymbol{\mu}]
\]
\medskip
\textbf{2. Compute PCA}
\[
...
U_K \text{ (top eigenvectors = eigenfaces)}
\]
\medskip
\textbf{3. Project and classify}
\[
\mathbf{z} = U_K^\top (\mathbf{x}-\boldsymbol{\mu})
\]
1-NN in PCA space (Euclidean distance).
\end{frame}
...
\begin{frame}{Eigenfaces: Hyperparameter Dependence}
\begin{itemize}
...
\medskip
\centering
\includegraphics[width=0.6\linewidth]{../../figures/eigenfaces_hyper.png}
\end{frame}

% ------------------ Eigenfaces Robustness Figures ------------------
\begin{frame}{Eigenfaces: Global Transformations}
\begin{itemize}
...
\end{itemize}
\centering
\includegraphics[width=0.85\linewidth]{../../figures/eigenfaces_noise.png}
\end{frame}
...
\medskip
\centering
\includegraphics[width=0.80\linewidth]{../../figures/Fisherfaces_robustness.png}
\end{frame}
